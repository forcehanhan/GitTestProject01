...
————————————————
版权声明：本文为CSDN博主「于子潇」的原创文章，遵循 CC 4.0 BY-SA 版权协议，转载请附上原文出处链接及本声明。
原文链接：https://blog.csdn.net/yzx5452830/article/details/78725118
 */
using System;
using UnityEngine;

/// <summary>本地数据管理类 </summary>
public class _023_03_GameDataManager
{

    /// <summary>储存bool类型数据</summary><param name="key">键</param><param name="value">值</param>
    public static void SetBool(string key, bool value) {
        PlayerPrefs.SetString(key + "Bool", value.ToString());
    }

    /// <summary>取出bool类型数据</summary><param name="key">键</param><returns></returns>
    public static bool GetBool(string key) {
        try
        {
            return bool.Parse(PlayerPrefs.GetString(key + "Bool"));//将值转换成bool类型的值,如果数据正确,则返回bool
        }
        catch (Exception e)
        {
            return false;
    ...
    /// <summary>储存string类型数据 </summary><param name="key">键</param><param name="value">值</param>
    public static void SetString(string key, string value) {
        PlayerPrefs.SetString(key, value);
    }

    /// <summary> 取出string类型数据</summary><param name="key">键</param><returns></returns>
    public static string GetString(string key) {
        return PlayerPrefs.GetString(key);
    }

    /// <summary> 储存Float </summary><param name="key">键</param><param name="value">值</param>
    public static void SetFloat(string key, float value) {
        PlayerPrefs.SetFloat(key, value);
    }

    /// <summary>取Float</summary><param name="key">键</param><returns></returns>
    public static float GetFloat(string key) {
        return PlayerPrefs.GetFloat(key);
    }

    /// <summary>储存Int</summary><param name="key">键</param><param name="value">值</param>
    public static void SetInt(string key, int value) {
        PlayerPrefs.SetInt(key, value);
    }


    /// <summary>取Int</summary><param name="key">键</param><returns></returns>
    ...
    /// <summary>储存IntArray</summary><param name="key">键</param><param name="value">值</param>
    ...
    /// <summary>取IntArray</summary><param name="key">键</param><returns></returns>
    ...
    /// <summary>储存FloatArray</summary><param name="key">键</param><param name="value">值</param>
    ...
    /// <summary>取FloatArray</summary><param name="key">键</param><returns></returns>
    ...
    /// <summary>储存StringArray</summary><param name="key">键</param><param name="value">值</param>
    ...
    /// <summary>取StringArray</summary><param name="key">键</param> <returns></returns>
    ...
    /// <summary>储存Vector2</summary><param name="key">键</param><param name="value">值</param>
    ...
    /// <summary>取Vector2</summary><param name="key">键</param><returns></returns>
    ...
    /// <summary>储存Vector3</summary><param name="key">键</param><param name="value">值</param>
    ...
    /// <summary> 取Vector3</summary><param name="key">键</param><returns></returns>
    ...
    /// <summary>储存Quaternion</summary><param name="key">键</param><param name="value">值</param>
    ...
    /// <summary>取Quaternion</summary><param name="key">键</param><returns></returns>
